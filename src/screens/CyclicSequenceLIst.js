...
import CardItemCyclicSequenceList from './CardItemCyclicSequence';
...
const CyclicSequenceSettingsListScreen = ({ route }) => {
    ...
    const handleCardItemPress = (item) => {
        ...
        console.log(item)
        navigation.navigate('CyclicSequenceScreen', {
    ...
    return (
        <SafeAreaView style={{ flex: 1 }}>
            ...
            <Icon onPress={handleBack} name="chevron-left" size={30} color="green" />
                ...
                <FlatList
                    data={formDataList}
                    renderItem={({ item }) => <CardItemCyclicSequenceList item={item}
...
export default CyclicSequenceSettingsListScreen;