...
const RainSensorSettingsListScreen = ({ route }) => {
    ...
    const handleButtonClick = () => {
        ...
        navigation.navigate('RainSensorSettingsScreen', {
            dataModel: formData,
            isAddData: true
        })
    };
        ...
        <SafeAreaView style={{ flex: 1 }}>
            ...
            <Icon onPress={handleBack} name="chevron-left" size={30} color="green" />
                {/* <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'center', padding: 16 }}>
                   ...
                   <Text style={styles.title}>Rain Sensor setting</Text>
...
export default SoilMoistureSettingsListScreen;